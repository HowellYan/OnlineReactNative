...
class Bundle extends BundleBase {
  ...
  getEtag() {
    var getSourceStr = this.getSource();
    
    //var eTagBuffernon = crypto.createHash('md5').update(getSourceStr).digest('hex');
    //console.log("eTagBuffer non: "+eTagBuffernon);
    var writeBuffer = new Buffer(getSourceStr)
    var eTagBuffer = crypto.createHash('md5').update(writeBuffer).digest('hex');
    //console.log("eTagBuffer: "+eTagBuffer);
    var eTag = crypto.createHash('md5').update(eTagBuffer+"bestpay1234567890abcdefghijk").digest('hex');
    console.log("serverMD5Str: "+eTag);
    //var keyStr = crypto.createHash('md5').update("bestpay1234567890abcdefghijk").digest('hex');

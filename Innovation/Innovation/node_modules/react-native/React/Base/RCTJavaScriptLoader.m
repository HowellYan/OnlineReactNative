  ...
  NSURLSessionDataTask *task = [[NSURLSession sharedSession] dataTaskWithURL:scriptURL completionHandler:
    ...
    if ([response isKindOfClass:[NSHTTPURLResponse class]] && ((NSHTTPURLResponse *)response).statusCode != 200) {
      ...
      return;
                                  ...
                                  NSString *key = @"bestpay1234567890abcdefghijk";
                                  if ([response respondsToSelector:@selector(allHeaderFields)]) {
                                    ...
                                    NSString *fileMd5 = RCTMD5Hash([NSString stringWithFormat:@"%@%@", RCTMD5Hash(aString), key]);
                                    NSLog(@"MD5_file:%@",fileMd5);
      
                                    if([Etag isEqualToString:fileMd5]){
                                      NSLog(@"bundle File 校验成功！");
                                    } else {
                                      NSLog(@"bundle File 校验失败！");
                                    }
                                  }
